...
export function buildKajiUlangHeader(logoSrc = logoDefault) {
  return buildHeader(logoSrc || logoDefault, 'FORMULIR PERMOHONAN');
}

export function buildFormulirHeader(logoSrc = logoDefault) {
  return buildHeader(logoSrc || logoDefault, 'FORMULIR');
}
